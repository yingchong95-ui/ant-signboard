...
(function () {
  ...
  var SYSTEM_PROMPT =
    ...
    '回答规则：\n' +
    '1. 用简体中文、英文或马来文（Bahasa Melayu）回复，自动跟随用户的语言\n' +
    ...
    '6. 用户询问订单进度或给出订单号（SHOP-…/DS-…/SB-…）时，用链接 [查询订单进度](https://ant-signboard.netlify.app/track.html?id=订单号) 引导他查看实时进度（把"订单号"换成实际订单号）';
